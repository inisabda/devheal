...
include "../config/setting.php";
    ...
    $query_daft = mysqli_query($mysqli,"SELECT * from tbl_suratsehat WHERE no_daftar ='$no_daftar' ");
        ...
        <tbody>
            <tr>
                <td style="text-align:justify;" width="690">
                    <p>Yang bertanda tangan dibawah ini <?php echo $dokter; ?> selaku dokter pemeriksa, menerangkan bahwa :  </p>            
                    <table width="100%">
                        <tbody>
                            <tr>
                                <td width="20%">Nama</td>
                    ...
                    <br>Pada hari ini telah kami periksa dengan teliti kesehatannya dan berpendapat bahwa kesehatan saudara tersebut pada waktu periksa dinyatakan : <b><?php echo $kesimpulan; ?></b>.
                    <br>Surat keterangan ini dipergunakan untuk : <b><?php echo $keperluan; ?></b>
    ...
    <table style="margin-left:30px;" border="0">
        <tbody>
            <tr>
                ...
                <td style='padding-right:8px; font-size: 10px;' align='left'></td>
                <td style='padding-right:8px; font-size: 10px;' width='230' align=''></td>
                <td style='font-size: 12px;' width="242" align='center'><?php echo $kab; ?>, <?php echo tgl_eng_to_ind($tanggal_periksa); ?>.
                    <br>
...
<?php
$filename="Cetak_Surat_Sehat.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
