<?php 
	...
	$no_kartu_bpjs = @mysqli_real_escape_string($conn, $_POST['no_kartu_bpjs']);
	...
	$query = "INSERT INTO tbl_pasien VALUES('$nomor_rm', '$nama_pas', '$jk','$tpt_lahir','$tgl_lahir', '$pekerjaan', '$alergi', '$no_hp', '$alm_pas','$nomor_rm','$nik', '$agama', '$desa','$kec','$kab_kota','$provinsi','$poscode','$tgl_masuk','$id','$no_kartu_bpjs')";
