<?php 
	...
	if($hasil_validasi) {
		...
		$query = "UPDATE tbl_pegawai SET nama_peg = '$nama', alamat_peg = '$alamat', hp_peg = '$no_hp', jk_peg = '$jk', tpt_lahir = '$tpt_lahir', lhr_peg = '$tgl_lahir', pos_peg = '$posisi', username = '$username', password = '$password' WHERE id_peg = '$id'";
