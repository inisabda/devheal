<?php 
	...
	$min_stok = $_POST['minstk_obat'];
	$bnt_obat = $_POST['bnt_obat'];
	...
	for($i = 0; $i < count($_POST["hidden_kdobat"]); $i++) {
		...
		$nama_obat = $_POST['hidden_nmobat'][$i];
		$no_batch = $_POST['hidden_no_batch'][$i];
		$ktg_obat = $_POST['hidden_ktgobat'][$i];
		...
		$query_estok = "INSERT INTO tbl_dataobat (kd_obat, nm_obat, exp_obat, ktg_obat, bnt_obat, sat_obat, hrg_obat, hrgbeli_obat, stk_obat, minstk_obat, no_batch, supplier) VALUES('$kd_obat', '$nama_obat', '$exp_obat', '$ktg_obat', '$bnt_obat', '$sat_jual', '$harga_jual', '$harga', '$jml_obat', '$min_stok', '$no_batch', '$nm_supplier')";
