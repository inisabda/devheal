...
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4><i class="fas fa-file-invoice-dollar"></i> Form Laporan Penjualan Obat / Alkes</h4></div>
                ...
                <div class="form-check">
	          	  ...
	          	  <div class="form-check">
	              	...
	              	<label class="form-check-label" id="label_tgl_akhir" style="font-weight: lighter; font-size: 14px; display: none;">
					    ...
					    <div class="col-sm-9">
					      <input type="date" class="form-control form-control-sm" name="per_tanggal1" id="per_tanggal1" placeholder="pilih tanggal awal" disabled="">
