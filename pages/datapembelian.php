...
<div class="page-content">
	<div class="row">
		...
		<div class="col-6 text-right">
            <a href="?page=form_laporanpembelian" class="btn btn-sm btn-pink">Buat Laporan Pembelian</a>
            <!-- <a href="?page=laporpembelian_apotek" class="btn btn-sm btn-pink">Buat Laporan Pembelian</a> -->
            <a href="?page=entry_datapembelian"><button class="btn btn-sm btn-info">Transaksi Pembelian Obat</button></a>
        </div>
	</div>
    <style>
        ul.nav-pills{
    ...
    <div class="kotak-data-tab">
    	<ul class="nav nav-pills" id="pills-tab" role="tablist">
          <?php 
           ...
           ?>
          <li class="nav-item">
            <a class="nav-link active" id="dpembelian_lunas-tab" data-toggle="pill" href="#dpembelian_lunas" role="tab" aria-controls="dpembelian_lunas" aria-selected="true">Lunas <sup style="font-size: 16px; color: green; font-weight: bold;">(<?php echo $jml_lunas; ?>)</sup></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="dpembelian_utang-tab" data-toggle="pill" href="#dpembelian_utang" role="tab" aria-controls="dpembelian_utang" aria-selected="false">Utang <sup style="font-size: 16px; color: red; font-weight: bold;">(<?php echo $jml_utang; ?>)</sup></a>
          </li>
                        ...
                        <?php 
                         ...
                         ?>
                            <tr>
                                ...
                                <td><?php echo date('d-m-Y',strtotime($dlunas['tgl_pembelian'])); ?></td>
                                <td><?php echo $dlunas['nama_supp']; ?></td>
                                <td class="text-right">Rp. <?php echo number_format($dlunas['total_pembelian'],2,',','.'); ?></td>
                                ...
                                <td class="td-opsi">
                                    ...
                                    <a href="laporan/nota_pembelianoke.php?no_faktur=<?php echo $dlunas['no_faktur']; ?>" target="_blank">
                                      <button class="btn-transition btn btn-outline-dark btn-sm" title="cetak" id="tombol_cetak" name="tombol_cetak"><i class="fas fa-print"></i>
                                      </button>
                                    </a>
