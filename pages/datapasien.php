...
<div class="page-content">
	<div class="row">
		<div class="col-8" id="judul">
			<h4><i class="fas fa-users"></i> Data Pasien <?php echo $nama_klinik; ?></h4>
		</div>
				...
				if(!ok.dismiss) {
					...
					Swal.fire({
						...
						onClose: () => {
							...
							$.ajax({
								url: "pages/import_data_pasien/import_pasien.php",
								method: "POST",
								...
								success: (res) => {
									...
									Swal.fire({
										...
										$('#tabel_datapasien').DataTable().ajax.reload();
									});
								},
								error: (err) => {
									console.log(err)
