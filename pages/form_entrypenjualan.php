<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Form Transaksi Penjualan Obat / Alkes</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4><i class="fas fa-file-invoice-dollar"></i> Form Transaksi Penjualan Obat / Alkes</h4></div>
		<div class="col-6 text-right">
			<a href="?page=datapenjualan">
				<button class="btn btn-sm btn-info">Data Penjualan</button></a>&nbsp;
            <a href="?page=laporpenjualan_apotek">
                <button class="btn btn-sm btn-warning" title="Export Data Penjualan">Laporan Penjualan</button></a>
		</div>
	</div>
			...
			<div class="col-md-12 vertical-form">
                ...
                <form method="post" id="form_penjualan" autocomplete="off">
                    ...
                    <div class="text-right tombol-kanan">
                        <button type="submit" name="simpan_penjualan" id="simpan_penjualan" class="btn btn-info"><i class="fas fa-save"></i> Simpan</button>
                    </div>
                </form>
			</div>
		</div>
                ...
                <table id="tabel_dataobat" class="table table-striped display">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Rp. <?php echo number_format($data['hrg_obat']); ?></td>
