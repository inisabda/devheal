...
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Data Penjualan per Obat dan Alkes</h4></div>
		<div class="col-6 text-right">
			<a href="?page=datapenjualan">
				<button class="btn btn-sm btn-warning"><i class="fas fa-file-invoice-dollar"></i> Data Penjualan</button>
			</a>
		</div>
	</div>
		...
		<table id="tbl_pjlobat" class="table table-striped display tabel-data">
			...
			?>
				<tr>
					...
					<td>Rp. <?php echo number_format($data_pjlobat['keuntungan']); ?></td>
				</tr>
			<?php } ?>
			</tbody>
		</table>
