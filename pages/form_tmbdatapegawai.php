...
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4><i class="fas fa-users"></i> Form Tambah Data Pegawai</h4></div>
		<div class="col-6 text-right">
			<a href="?page=datapegawai">
				<button class="btn btn-sm btn-warning"><i class="fas fa-list"></i> List Data Pegawai</button>
			</a>
		</div>
	</div>
	<div class="form-container">
		<div class="row">
			<div class="col-md-6 offset-md-3 offset-form">
				...
				<form method="POST" id="simpan_pegawai">
              ...
              <div class="form-check">
				  ...
				  <div class="form-group row pt-1">
				    <label for="tlahir_peg" class="col-sm-3 col-form-label">Tempat & Tgl Lahir</label>
				    <div class="col-sm-5">
				      <input type="text" class="form-control form-control-sm" id="tpt_lahir" placeholder="Tempat lahir">
				    </div>
				    <div class="col-sm-4">
				      <input type="date" class="form-control form-control-sm" id="tlahir_peg">
                ...
                <div class="input-group-append">
				  ...
				  <div class="form-group row">
				    <div class="col-sm-12 text-right">
				      <button type="button" class="btn btn-danger btn-sm" id="btn_reset"><i class="fas fa-forward"></i> Reset</button>
				      <button type="submit" class="btn btn-info btn-sm" id="btn_simpan"><i class="fas fa-save"></i> Simpan</button>
				    </div>
				  </div>
				</form>
			</div>
...
<script>
	...
	$("#simpan_pegawai").on("submit", function(event){
    event.preventDefault();
		...
		if(nama=="" || cek_nama) {
			...
			document.getElementById("tpt_lahir").focus();
			Swal.fire(
			  'Data Belum Lengkap',
			  'maaf, tolong isi tempat lahir pegawai',
			  'warning'
			)
		} else if (alamat=="") {
			...
			$.ajax({
				...
				data: "nama="+nama+"&posisi="+posisi+"&tpt_lahir="+tpt_lahir+"&tgl_lahir="+tgl_lahir+"&alamat="+alamat+"&username="+username+"&password="+password+"&jk="+jk+"&no_hp="+no_hp,
