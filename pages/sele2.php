    ...
    <div class="row">
        ...
        <div class="col-6 text-right">
            <a href="?page=datapenjualan">
                ...
                <button class="btn btn-sm btn-warning" title="Export Data Penjualan">Export</button>
            </a>
        </div>
    </div>
        ...
        <div class="row" style="padding: 0 16px;">
            <div class="col-md-12 vertical-form">
                ...
                <?php 
                    ...
                    $carikode = mysqli_query($conn, "SELECT MAX(no_pengobatan) FROM tbl_pengobatan WHERE tgl_penjualan = '$tgl_penjualan'") or die (mysql_error());
                    $datakode = mysqli_fetch_array($carikode);
                    if($datakode) {
                        $nilaikode = substr($datakode[0], 13);
                        $kode = (int) $nilaikode;
                        $kode = $kode + 1;
                        $no_penjualan = "RES/".$tgl."/".str_pad($kode, 3, "0", STR_PAD_LEFT);
                    } else {
                        $no_penjualan = "RES/".$tgl."/001";
                    }
                 ?>
...
<!--                   <th>Harga</th> -->
    ...
    $no_rawat = @$_GET['id'];
                ...
                $nomor = 1;
                $query_pjlobat = "SELECT tbl_pengobatandetail.*, tbl_pengobatandetail.kd_obat, tbl_pengobatan.no_rawat, tbl_dataobat.kd_obat, tbl_dataobat.nm_obat, tbl_dataobat.hrg_obat FROM tbl_pengobatandetail
