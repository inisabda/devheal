...
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4><i class="fas fa-user-edit"></i> Form Edit Data Pegawai</h4></div>
	...
	<div class="form-container">
		<div class="row">
			<div class="col-md-6 offset-md-3 offset-form">
				...
				<form method="POST" id="edit_pegawai">
                ...
                <div class="input-group-append">
				  ...
				  <div class="form-group row pt-1">
				    <div class="col-sm-12 text-right">
				      ...
				      <button class="btn btn-danger btn-sm"><i class="fas fa-save"></i> Simpan Perubahan</button>
				    </div>
				  </div>
				</form>
			</div>
...
<script>
	...
	$("#edit_pegawai").on("submit", function(event){
