...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Laporan Penjualan Apotek</li>
  </ol>
</nav>
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Penjualan Obat / Alkes</h4></div>
    <div class="col-6 text-right">
      <a href="?page=entry_datapenjualan">
        <button class="btn btn-sm btn-info"><i class="fas fa-plus-circle"></i> Tambah Penjualan</button>
      </a>
    ...
    <div class="row data-penjualan">
      ...
      <div class="position-relative form-group col-md-2">
        <label for="cetak" class="">Cetak Detail</label>
          <a href="?page=form_laporanpenjualan">
