            ...
            if ($jumlah < 1) {
                ...
                if ($sisa['stok_barang'] < $jumlah) {
                    ...
                    if ($num > 0) {
                        ...
                        header("location:PageKasir.php?page=transaksi");
                    }else{
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="kd_barang" placeholder="Kode barang" value="<?php echo @$dataR['kd_barang'] ?>">
<!--                                                 value="<?php echo @$dataR['kd_barang'] ?>" -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_barang" value="<?php echo @$dataR['nama_barang']; ?>" >
                                    </div>
                                    <div class="form-group">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                    ...
                    <tbody>
                        ...
                        <!-- <a href="?page=edit_datapasien&id=<?php echo $data['id_peg']; ?>"> -->
                            ...
                            <td><a href="page=transaksi&getItem&id=<?php echo $brs['kd_barang'] ?>"><?php echo $brs['kd_barang'] ?></a></td>
