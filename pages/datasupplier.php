			    ...
			    <tbody>
						<?php 
				 		...
				 		<tr>
				 			...
				 			<td class="td-opsi">
				 				<button class="btn-transition btn btn-outline-primary btn-sm" title="edit" id="tombol_edit" name="tombol_edit" data-id="<?php echo $data['no_supp']; ?>"><i class="fas fa-edit"></i></button>
		            <button class="btn-transition btn btn-outline-danger btn-sm" title="hapus" id="tombol_hapus" name="tombol_hapus" data-id="<?php echo $data['no_supp']; ?>" data-nama="<?php echo $data['nama_supp']; ?>"><i class="fas fa-trash"></i></button>
		          </td>
				 		</tr>
			 			<?php } ?>
			    </tbody>
