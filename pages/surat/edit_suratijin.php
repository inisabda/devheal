...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Form Edit Surat Ijin</li>
  </ol>
</nav>

<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Form Edit Surat Ijin Pasien</h4></div>
...
<div class="form-container">
	<div class="row" style="padding: 0 40px;">
		<div class="col-md-12 vertical-form">
			<h6><i class="fas fa-list-alt"></i> Lengkapi form ini untuk mengedit surat ijin</h6>
			<div class="row" style="padding: 0 20px;">
	            <div class="col-md-12 mt-2 vertical-form">
	            	<form method="post" id="edit_ijin" autocomplete="on">
						<?php 
				          $no_surat = @$_GET['id'];
							$hari_ini = date("d-m-Y");
							$query_tampil = "SELECT * FROM tbl_suratijin WHERE no_surat='$no_surat'";
				        ...
				        <div style="text-align: right;">
				        	No surat : <b><?php echo $no_surat; ?></b>	Tanggal : <b><?php echo date('d-m-Y', strtotime($data['tgl_periksa'])); ?></b>
				        </div>
						...
						<div class="form-group row pt-1">
			                ...
			                <div class="col-sm-4">
			                	<input type="text" class="form-control form-control-sm" name="nama_pas" id="nama_pas" value="<?php echo $data['nama_pas']; ?>" >
							</div>
			            ...
			            <div class="form-group row pt-1">
			                ...
			                <div class="col-sm-4">
						    	<input type="text" class="form-control form-control-sm" name="alm_pas" id="alm_pas" value="<?php echo $data['alm_pas']; ?>" >
							</div>
							<label for="nomor_rm" class="col-sm-2 col-form-label" style="text-align: left;">Nomor RM</label>
							<div class="col-sm-4">
							    <div class="input-group-append">
			            	       <input type="text" class="form-control form-control-sm" name="nomor_rm" id="nomor_rm" value="<?php echo $data['nomor_rm']; ?>" >
								</div>
							</div>									
						</div>
						<div class="form-group row pt-1">
			                ...
			                <span class="col-sm-2">
						    	<input type="text" class="form-control form-control-sm" name="tpt_lahir" id="tpt_lahir" value="<?php echo $data['tpt_lahir']; ?>" >
						    </span>
						    <span class="col-sm-2">
						    	<input type="date" class="form-control form-control-sm" name="lhr_pas" id="lhr_pas" value="<?php echo $data['lhr_pas']; ?>" >
							</span>
						...
						<div class="form-group row pt-1">
			                ...
			                <div class="col-sm-4">
						    	<input type="text" class="form-control form-control-sm" name="jk_pas" id="jk_pas" value="<?php echo $data['jk_pas']; ?>" >
							</div>
							
							<label for="diagnosa" class="col-sm-2 col-form-label" style="text-align: left;">Diagnosa</label>
							<div class="col-sm-4">
							    <div class="input-group-append">
			            	       <input type="text" class="form-control form-control-sm" name="diagnosa" id="diagnosa" value="<?php echo $data['diagnosa']; ?>">
								</div>
							</div>		
			        	...
			        	<div class="form-group row pt-1">
			                ...
			                <div class="col-sm-2">
			                	<input type="number" class="form-control form-control-sm " name="istirahat" id="istirahat" value="<?php echo $data['istirahat']; ?>">
			              	</div>
			              	<label for="mulai_tanggal" class="col-sm-2 col-form-label"> hari, terhitung mulai tgl</label>
			                <div class="col-sm-2">
						    	<input type="date" class="form-control form-control-sm" name="mulai_tanggal" id="mulai_tanggal" value="<?php echo $data['mulai_tanggal']; ?>">
							</div>
							<label for="akhir_tanggal" class="col-sm-1 col-form-label" style="text-align: left;">s/d Tanggal</label>
							<div class="col-sm-2">
						    	<input type="date" class="form-control form-control-sm" name="akhir_tanggal" id="akhir_tanggal" value="<?php echo $data['akhir_tanggal']; ?>">
							</div>				              	
			            </div>
...
<script>
	 $("#nm_dokter").click(function() {
   	...
   	$("#edit_ijin").on("submit", function(event){
