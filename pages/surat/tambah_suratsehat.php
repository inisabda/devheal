...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4><i class="fas fa-envelope"></i> Form Surat Keterangan Sehat</h4></div>
        <div class="col-6 text-right">
            <a href="?page=suratsehat">
                <button class="btn-transition btn btn-outline-success btn-xl"><i class="fas fa-envelope"></i> Data SUKET Sehat</button>
            </a>
        </div>
    </div>
			...
			<div class="col-md-12 vertical-form">
				...
				<div class="row" style="padding: 0 0px;">
		            <div class="col-md-12 mt-2 vertical-form">
		            	<form method="post" id="tambah_sehat" autocomplete="on">
							<?php 
				        	...
				        	<div class="form-group row pt-1">
								...
								<div class="col-sm-4">
									<input type="text" name="keperluan" id="keperluan" class="form-control form-control-sm" value="">
								</div>
								<label for="butawarna" class="col-sm-1 col-form-label">buta warna</label>
								<div class="col-sm-2">
									<input type="text" name="butawarna" id="butawarna" class="form-control form-control-sm" value="<?php echo $butawarna; ?>">
								</div>
							</div>
				        	Masa berlaku surat ini 1 bulan sejak surat keterangan ini di keluarkan.
...
<script>
	...
	$("#tambah_sehat").on("submit", function(event){
