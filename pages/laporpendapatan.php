...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Laporan Pendapatan Klinik</li>
  </ol>
</nav>
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Pendapatan Klinik Per Bulan</h4></div>
