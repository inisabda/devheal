...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Form Racik Obat baru</li>
  </ol>
</nav>
                ...
                <div class="row data-racikan">
                    <div class="position-relative form-group col-md-4">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-sm" id="nama_racikan" name="nama_racikan" placeholder="Masukkan nama obat racikan" autofocus="" value="" >
                        </div>
                    </div>
                    <div class="position-relative form-group col-md-4">
                    ...
                    <div class="row kotak-form-tabel-racikan">
                        ...
                        <div class="col-md-9 kotak-tabel-obat-terjual">
                            <table class="table display tabel-data">
                                ...
                                <tfoot>
                                    <tr id="baris_kosong">
                                        <td colspan="7" class="text-center">Belum ada data racikan</td>
                                    </tr>
